...
public class PhoneLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputUserPhoneNumber = (EditText) findViewById(R.id.phone_login_number);
        InputUserVerificationCode = (EditText) findViewById(R.id.verifiy_code_text);
        SendVerificationCodeButton = (Button) findViewById(R.id.send_verification);
